    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(mode="w", encoding="utf-8", errors="ignore", delete=False) as tmp_file:
            ...
            if sys.platform == "win32":
                ...
                CButton_new_pattern = r'$(k,E(Ks,{title:"youzhiqingw GitHub",size:"small",get codicon(){return F.rocket},get onClick(){return function(){window.open("https://github.com/youzhiqingw/cursor-free-vip","_blank")}}}),null)'
                ...
                CButton_new_pattern = r'M(x,I(as,{title:"youzhiqingw GitHub",size:"small",get codicon(){return $.rocket},get onClick(){return function(){window.open("https://github.com/youzhiqingw/cursor-free-vip","_blank")}}}),null)'
